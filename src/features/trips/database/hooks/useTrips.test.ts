...
describe('useTrips', () => {
  ...
  it('returns trips data, isLoading, and error', () => {
    const trips = [{ id: '1', name: 'Tokyo Trip', status: 'upcoming' as const, createdAt: 0, updatedAt: 0, destination: null, startDate: null, endDate: null, tripType: null, notes: null }];
